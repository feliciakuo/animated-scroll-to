...
var _GoSomewhere = __webpack_require__(19);

var _GoSomewhere2 = _interopRequireDefault(_GoSomewhere);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _GoSomewhere2.default;
...
var _easingJs = __webpack_require__(38);
...
exports.default = function (BaseComponent) {
  var GoSomewhere = function (_Component) {
    _inherits(GoSomewhere, _Component);

    function GoSomewhere() {
      _classCallCheck(this, GoSomewhere);

      var _this = _possibleConstructorReturn(this, (GoSomewhere.__proto__ || Object.getPrototypeOf(GoSomewhere)).call(this));
      ...
      _this.animateToTarget = _this.animateToTarget.bind(_this);
      _this.getScrollPosition = _this.getScrollPosition.bind(_this);
      _this.animationLoop = _this.animationLoop.bind(_this);
      _this.stopEverything = _this.stopEverything.bind(_this);
      _this.checkIsBottom = _this.checkIsBottom.bind(_this);
      return _this;
    }

    _createClass(GoSomewhere, [{
      ...
      value: function shouldComponentUpdate(nextProps, nextState) {
        return nextState.ScrollPosition !== this.state.ScrollPosition || nextState.startLoop !== this.state.startLoop || nextState.targetOffsetTop !== this.state.targetOffsetTop || nextProps.targetId !== this.props.targetId || nextProps.verticalDisplacement !== this.verticalDisplacement;
      }
    }, {
      ...
      value: function getCurrentValue() {
        ...
        var _state = this.state,
            ScrollPosition = _state.ScrollPosition,
            targetOffsetTop = _state.targetOffsetTop;


        var changeInValue = targetOffsetTop - ScrollPosition > 0 ? targetOffsetTop - ScrollPosition : -ScrollPosition;

        return (0, _easingJs.easeOutCubic)(iteration, ScrollPosition, changeInValue, 120);
      }
    }, {
      key: 'animateToTarget',
      value: function animateToTarget() {
        if (this.isMount) {
          // do something when the up arrow is clicked
          var _props = this.props,
              targetId = _props.targetId,
              verticalDisplacement = _props.verticalDisplacement;
      ...
      key: 'checkIsBottom',
      value: function checkIsBottom() {
        var atTheBottomOfThePage = window.innerHeight + window.scrollY >= document.body.offsetHeight;

        if (atTheBottomOfThePage) {
          return true;
        }
        return false;
      }
      ...
      value: function animationLoop() {
        var _state2 = this.state,
            startLoop = _state2.startLoop,
            targetOffsetTop = _state2.targetOffsetTop,
            ScrollPosition = _state2.ScrollPosition;
        ...
        if (startLoop) {
          ...
          var isTopToBottom = targetOffsetTop - ScrollPosition > 0;
          var condition = isTopToBottom ? this.getScrollPosition() >= targetOffsetTop || this.checkIsBottom() : this.getScrollPosition() <= targetOffsetTop;
      ...
      value: function render() {
        return _react2.default.createElement(BaseComponent, _extends({}, this.props, { handleAnimate: this.animateToTarget }));
      }
    }]);
  ...
  GoSomewhere.propTypes = {
    ...
    verticalDisplacement: _react.PropTypes.number
  };
